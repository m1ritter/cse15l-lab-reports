...
The handleRequest( ) method is called when a string, such as "Hello" is added to the URL after the equal sign. The method takes in arguments of type URI and the variable called 'string' gets elements added to it. For example, "Hello" is added after the /add-message?s=Hello request.<br> 
